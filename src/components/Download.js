const Download = () => {
    return (
      <div className="py-20 mt-20">
        ...
        <div className="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-16 max-w-screen-lg mt-16">
          <div className="flex flex-col rounded-md shadow-md lg:mb-16">
            ...
            <div className="flex p-6">
              <button
                type="button"
                className="btn flex-1 btn-purple hover:bg-bookmark-white hover:text-black"
              >
          ...
          <div className="flex flex-col rounded-md shadow-md lg:my-8">
            <div className="p-6 flex flex-col items-center">
              <img src="./assets/images/logo-firefox.svg" alt="chrome" />
              <h3 className="mt-5 mb-2 text-bookmark-blue text-lg">
                Add to Firefox
              </h3>
              <p className="mb-2 text-bookmark-grey font-light">
          ...
          <div className="flex flex-col rounded-md shadow-md lg:mt-16">
            <div className="p-6 flex flex-col items-center">
              <img src="./assets/images/logo-opera.svg" alt="chrome" />
              <h3 className="mt-5 mb-2 text-bookmark-blue text-lg">
                Add to Opera
              </h3>
              <p className="mb-2 text-bookmark-grey font-light">
