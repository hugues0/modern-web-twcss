          ...
          <div className="container flex flex-col lg:flex-row items-center justify-center gap-x-24">
            ...
            <div className="flex flex-1 flex-col items-center lg:items-start">
              ...
              <p class="text-bookmark-grey my-4 text-center lg:text-left sm:w-3/4 lg:w-full">
                ...
                drang-and-drop interface gives you complete control over how you
        ...
        <div className="relative mt-20 lg:mt-52">
          <div className="container flex flex-col lg:flex-row-reverse items-center justify-center gap-x-24">
            ...
            <div className="flex flex-1 flex-col items-center lg:items-start">
              ...
              <p class="text-bookmark-grey my-4 text-center lg:text-left sm:w-3/4 lg:w-full">
                Our powerful search feature will help you find saved sited in no
        ...
        <div className="relative mt-20 lg:mt-52">
          <div className="container flex flex-col lg:flex-row items-center justify-center gap-x-24">
            ...
            <div className="flex flex-1 flex-col items-center lg:items-start">
              ...
              <p class="text-bookmark-grey my-4 text-center lg:text-left sm:w-3/4 lg:w-full">
                Easily share your bookmarks and collecions with your friends. 
          ...
          <div className="hidden lg:block overflow-hidden bg-bookmark-purple rounded-r-full absolute h-80 w-2/4 -bottom-24 --36"></div>
        </div>
      </div>
    );
}
